...
function ShopPage() {
  return <>
    ...
    <section className="section-block"><div className="container-wide">
      <div className="shop-toolbar"><p><strong>{products.length}</strong> products</p><Button variant="outline" type="button" aria-label="Filter products"><SlidersHorizontal /> Filter & sort</Button></div>
